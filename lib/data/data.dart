...
String apiKey = 'API PEXEL';

String trendingWallpaperUrl = 'https://api.pexels.com/v1/curated?&per_page=10&page=1';

// String searchWallpaperUrl = 'https://api.pexels.com/videos/search?query=${searchController}&per_page=1'
